...
class FaceUtil:
    ...
    def get_face_location_and_name(self,image):
        ...
        for encoding in encodings:
            ...
            matches = face_recognition.compare_faces(
                      ...
                      tolerance = self.tolerance)#与加载的数据进行匹配
            name = "Unknown"
            ...
            if True in matches:
                ...
                for i in matched_idxs:
                    ...
                    counts[name] = counts.get(name, 0) + 1 #投票
    ...
    def save_embeddings(self, image_paths, output_encoding_file_path):
        ...
        if os.path.exists(output_encoding_file_path):
           data1 = pickle.loads(open( output_encoding_file_path,"rb").read())
           print(data1["encodings"])
           print(data1["names"])
           for encoding in data1["encodings"]:
                known_encodings.append(encoding)
